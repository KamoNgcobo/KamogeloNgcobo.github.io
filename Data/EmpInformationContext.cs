...
{
    public partial class EmpInformationContext : DbContext
    {
        public EmpInformationContext()
        {
        }

        public EmpInformationContext(DbContextOptions<EmpInformationContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Initial Catalog=EmpInformation;Data source=DESKTOP-UI0V5FN;Trusted_Connection=true");
            }
        }
